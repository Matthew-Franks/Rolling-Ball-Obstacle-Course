...
public class LevelEightBall : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		{
			levelEightText.gameObject.SetActive(false);
		}
	...
	void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Token"))
		{
			...
			count++;
			endLevelText.text = "Congratulations! Press [SPACE] to advance to the ninth level!";
		}
	}
}
