...
public class LevelFiveTutorial : MonoBehaviour
{
	...
	public Text levelFiveTutorialText;
	...
	void FixedUpdate ()
	{
		...
		{
			levelFiveTutorialText.gameObject.SetActive(false);
		}

		if (transform.position.y < -3)
		{
			SceneManager.LoadScene("Level 5 Tutorial", LoadSceneMode.Single);
		}
	...
	void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Token"))
		{
			...
			count++;
			endLevelText.text = "Awesome! Press [SPACE] to advance to the fifth level!";
		}
	}
}
