...
public class LevelSevenBall : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		{
			levelSevenText.gameObject.SetActive(false);
		}
	...
	void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Token"))
		{
			...
			count++;
			endLevelText.text = "Congratulations! Press [SPACE] to advance to the eighth level!";
		}
	}
}
