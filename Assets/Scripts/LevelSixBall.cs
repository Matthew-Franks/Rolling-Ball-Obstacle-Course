...
public class LevelSixBall : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		{
			levelSixText.gameObject.SetActive(false);
		}
	...
	void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Token"))
		{
			...
			count++;
			endLevelText.text = "Congratulations! Press [SPACE] to advance to the seventh level!";
		}
	}
}
