...
public class LevelTenBall : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		...
		{
			levelTenText.gameObject.SetActive(false);
		}
		...
		if (transform.position.y < -3)
		{
			...
			SceneManager.LoadScene("Level 10", LoadSceneMode.Single);
		}
	...
	void OnTriggerEnter(Collider other)
	{
		if (other.gameObject.CompareTag("Token"))
		{
			...
			count++;
			endLevelText.text = "Congratulations! Press [SPACE] to continue!";
		}
	}
}
